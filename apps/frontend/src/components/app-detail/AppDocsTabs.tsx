  ...
  return (
    <section className="py-12 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Documentacao</h2>
            ...
            filtered.map((doc) => {
              ...
              return (
                <a
                  ...
                  className="flex items-start gap-3 bg-white border border-gray-100 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow"
                >
                  <Icon className="w-5 h-5 text-aegea-600 mt-0.5 flex-shrink-0" />
                  <div>
